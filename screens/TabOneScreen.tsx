...
switch(parameter){
        ...
        case 0:
                ...
                setCurrentKey('B'); setone(prevState => !prevState)
        
        case 1:
                setCurrentKey('C'); setone(prevState => !prevState)
        break;
        case 2:
                setCurrentKey('Db'); setone(prevState => !prevState)
                
        break;
        case 3:
                setCurrentKey('D'); setone(prevState => !prevState)
                
        break;
        case 4:
                setCurrentKey('Eb'); setone(prevState => !prevState)
                
        break;
        case 5:
                setCurrentKey('E'); setone(prevState => !prevState)
                
        break;
        case 6:
                setCurrentKey('F'); setone(prevState => !prevState)
        ...
        break;
        case 8:
                setCurrentKey('G'); setone(prevState => !prevState)
                
        break;
        case 9:

                setCurrentKey('Ab'); setone(prevState => !prevState)
                
        break;
        case 10:

                setCurrentKey('A'); setone(prevState => !prevState)

        break;
        case 11:
        
                setCurrentKey('Bb'); setone(prevState => !prevState)
...
<Text style={{zIndex: 3000, position: "relative", marginBottom:102, marginRight: 340, fontWeight: "900", fontSize: 22}}>{currentKey} Maj</Text>
:
<Text style={{zIndex: 3000, position: "relative", marginBottom:102, marginRight: 340, fontWeight: "900", fontSize: 22}}>{currentKey} Min</Text>
...
<TouchableOpacity style={{ }}
        onPress={()=>{ if(currentKeyNumber>0) { let wtf = currentKeyNumber -1;  setCurrentKeyNumber(currentKeyNumber-1); checkScale(wtf)}}}>
                <Text style={{marginRight: 6, borderRadius: 10, padding: 8, textAlign: 'center',fontSize: 19, fontWeight: "900", backgroundColor: 'dodgerblue'}}>--</Text>
                </TouchableOpacity>
        
        <TouchableOpacity style={{}}
        onPress={()=>{setMajorMinor()}}>
